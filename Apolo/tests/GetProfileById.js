...
const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MzEsImVtYWlsIjoiYmFjdWJvbjIwMTVAZ21haWwuY29tIiwiaWF0IjoxNzQzNzM1ODUyLCJleHAiOjE3NDYzMjc4NTJ9.GNXSk9UPSfEIAiM_urK1RvCetjVIwlpD5LpNA_uBp-I';
...
export default function(){
    ...
    console.log(`⚠️ Lỗi: Status Code ${res.status},⏱ Full time: ${res.timings.duration}ms`);
}