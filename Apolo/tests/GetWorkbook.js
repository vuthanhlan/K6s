...
const url = 'https://lms-apollo-api.m-team.asia/student/progress/workbook?classId=9';
...
export default function(){
    ...
    check(res, {
        ...
        'Response time < 500ms': (r) => r.timings.duration < 500, // Kiểm tra thời gian phản hồi dưới 1 giây
    });
