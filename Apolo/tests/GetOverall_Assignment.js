...
const url = 'https://lms-apollo-api.m-team.asia/student/progress/home-learning/assignments?classId=9&page=1&pageSize=10';
...
export default function(){
    ...
    check(res, {
        ...
        'Response time < 2500ms': (r) => r.timings.duration < 2500, // Kiểm tra thời gian phản hồi dưới 1 giây
    });
