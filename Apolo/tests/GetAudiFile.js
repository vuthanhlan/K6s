...
const url = 'https://lms-apollo-api.m-team.asia/student/library/audio-file?classId=9';
...
export default function(){
    ...
    check(res, {
        ...
        'Response time < 200ms': (r) => r.timings.duration < 200, // Kiểm tra thời gian phản hồi dưới 0,2 giây
    });
